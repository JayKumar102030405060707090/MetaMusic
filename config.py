...
# --------------------------------------------------------
BOT_USERNAME = getenv("BOT_USERNAME" , "Meta_musicBot")
# --------------------------------------------------------
BOT_NAME = getenv("BOT_NAME" , "Meta MUSIC")
# ---------------------------------------------------------
...
LOG_GROUP_ID = int(getenv("LOGGER_ID",-1002023049910))
# ----------------------------------------------------------------
# ----------------------------------------------------------------
...
SUPPORT_GROUP = "https://t.me/Komal_Music_Support"  # Example URL ya string
adminlist =int(getenv("OWNER_ID", 7168729089))# Tumhare admin IDs ki list
confirmer = True   # Ya koi bhi default value
